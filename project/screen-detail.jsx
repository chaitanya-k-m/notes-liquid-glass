// screen-detail.jsx — Note detail / Thought of the day

function DetailScreen({ go, dark = false, payload, titleFont = 'display' }) {
  return (
    <div style={{ position: 'relative', width: '100%' }}>
      ...
      {/* Stacked paper layers behind main card */}
      <div style={{ position: 'relative', padding: '0 22px', marginTop: 12 }}>
        ...
        >
          ...
          <div style={{
            ...
            Every day is a fresh start — embrace it with <mark style={{ background: 'rgba(255,210,120,0.55)', padding: '0 2px', borderRadius: 3, color: '#000' }}>hope</mark> and <mark style={{ background: 'rgba(255,170,200,0.5)', padding: '0 2px', borderRadius: 3, color: '#000' }}>courage</mark>. Let each moment inspire you to grow and shine brighter than before.
          </div>

          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8, marginTop: 16 }}>
            <div style={{ borderRadius: 14, overflow: 'hidden', aspectRatio: '1.4', position: 'relative' }}>
              <PlaceholderImage label="sunset" bg="#ec9a6e" stripe="#9b4a2b" />
            </div>
            <div style={{ borderRadius: 14, overflow: 'hidden', aspectRatio: '1.4', position: 'relative' }}>
              <PlaceholderImage label="petals" bg="#e0a8b8" stripe="#8a3a55" />
            </div>
          </div>
