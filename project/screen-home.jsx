// screen-home.jsx — Editorial bento home

function HomeScreen({ go, dark = false, accent = '#fff36a', mono = false, titleFont = 'display' }) {
  ...
  return (
    <div style={{ position: 'relative', width: '100%' }}>
      ...
      <div style={{ padding: '0 18px 12px' }}>
        <div onClick={() => go('detail', { kind: 'thought' })} style={{
          ...
          <div style={{ position: 'absolute', inset: 0 }}>
            <PlaceholderImage label="hero photo" bg="#c2a489" stripe="#5e4030" />
          </div>
          <div style={{
      ...
      <div style={{
        ...
        {/* Shopping list — pixel, tall left, spans 2 rows */}
        <GlassCard
          radius={26}
          padding={18}
          tint={tints.list}
        ...
        {/* Snapshots — wide photo card, full width */}
        <GlassCard
          radius={22}
          padding={0}
        ...
        >
          <div style={{ position: 'absolute', inset: 0 }}>
            <PlaceholderImage label="snapshots" bg="#a89175" stripe="#3f3022" />
          </div>
          <div style={{
            position: 'absolute', inset: 0,
          ...
          <div style={{
            ...
            {['#c2a489', '#8a7f9a', '#b88567', '#7e9bbc'].map((c, i) => (
              <div key={i} style={{
                flex: 1, height: 38, borderRadius: 10,
                background: c, opacity: 0.85,
                boxShadow: 'inset 0 0 0 1px rgba(255,255,255,0.3), 0 2px 6px rgba(0,0,0,0.2)',
              }} />
            ))}
            <div style={{
